        ...
        <aside className="w-72 bg-slate-800 border-r border-slate-700 flex flex-col h-full">
            ...
            <div className="px-4 py-3 border-b border-slate-700">
                ...
                <div className="space-y-1">
                    ...
                    <button
                        onClick={() => onNavigate({ level: 'account', view: 'creative_audit' })}
                        className={`w-full text-left px-3 py-2 rounded-lg transition-colors flex items-center gap-2 text-sm ${navigation.view === 'creative_audit'
                            ? 'bg-violet-600 text-white'
                            : 'hover:bg-slate-700 text-slate-300'
                            }`}
                    >
